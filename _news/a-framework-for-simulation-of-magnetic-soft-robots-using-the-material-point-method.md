...
This advancement aids in our goals to create patient-specific robot designs. By use of accurate simulation, we can optimise robot magnetisations and geometry in order to give desired real-world behaviour. Designs can also be validated quickly without the complexities of fabrication and experimental setup.
